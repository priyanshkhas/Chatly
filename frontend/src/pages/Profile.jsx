  ...
  const handleProfile = async (e) =>{
    ...
    //   setSaving(false);
      ...
      console.error("Profile update error:", 
        error.response?.status,               // e.g. 500
        error.response?.data,                 // likely contains your server’s error message or stack
    ...
    <div className='w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]'>
      ...
      <form className='w-[95%] max-w-[500px] flex flex-col gap-[20px] items-center justify-center' onSubmit={handleProfile}>
        ...
        <input
          ...
          className="w-[90%] h-[50px] outline-none border-2 border-[rgb(32,199,255)] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-400 shadow-lg text-gray-700 text-[19px]"
        ...
        <input
          type="text"
          readOnly
          className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-400 shadow-lg text-gray-400 text-[19px]" value={userData?.userName || 'User Name'}
        />
        <input
          type="email"
          readOnly
          className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-400 shadow-lg text-gray-400 text-[19px]" value={userData?.email || 'Email'}
        />
